...
import { ArrowLeft, BarChart2, Home, Layers, Network, TrendingUp, Users, Wallet, Book, Coins } from "lucide-react"
        ...
        <div className="bg-black/50 backdrop-blur-md border border-gray-800 rounded-full px-2 py-1">
          <div className="flex space-x-1">
            ...
            <NavButton
              ...
              label="Tracker"
              onClick={() => router.push("/wallet-tracker")}
              active={pathname === "/wallet-tracker"}
            />
            <NavButton
